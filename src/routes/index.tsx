  ...
  return (
    <section className="border-b hairline py-28 md:py-36">
      <div className="max-w-[1320px] mx-auto px-6 md:px-12">
        ...
        <p className="font-display text-3xl md:text-5xl leading-[1.15] tracking-[-0.02em] max-w-[30ch] text-ink">
          Curated to feel more like <em className="italic">a great night out</em> — not a traditional singles event.
        </p>
